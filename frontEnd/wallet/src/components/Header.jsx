...
export const Header =( ()=>{
    ...
    return(
        <div className={"header flex w-100 text-5xl align-middle justify-around"}>
            <h1 className={"ml-10"}>apex</h1>

            <div className={"nav-list flex justify-between text-2xl m-3 hover:cursor-pointer"}>
                ...
                <div className={"ml-10"}>
                {theme === "black" ?
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="sun" className={`w-10`} onClick={ ()=>setTheme("white") }>
                        <path
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="moon" className={`w-10 `} onClick={ ()=>setTheme("black")}>
                        <path
            ...
            <div className={"right-0"}>
                ...
                <button className={"btn btn-success ml-10 mr-5"}>Signup</button>
            </div>
        </div>
    )
})